...
result42a = euler_explicit(0, 1, 4, 1, f42);
result42b = find_order(0, 1, 1, f42);
disp1(result42a);
disp2(result42b);
plot1(result42a, "Q4byvst.png");
plot2(result42a, "Q4berrorvst.png");
plot3(result42b, "Q4bloglogn.png");
plot4(result42b, "Q4borderplot.png");
