...
result43a = euler_explicit(2, 3, 4, 2, f43);
result43b = find_order(2, 3, 2, f43);
disp1(result43a);
disp2(result43b);
plot1(result43a, "Q4cyvst.png");
plot2(result43a, "Q4cerrorvst.png");
plot3(result43b, "Q4cloglogn.png");
plot4(result43b, "Q4corderplot.png");
...
function result = exact_value(f, init_val, a, x)
    syms t;
    f1 = exp(-t) * (((sqrt(2) * exp(1)) + exp(t / 2) * (t - 2)) ^ 2);
