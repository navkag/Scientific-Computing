...
f41 = @(t, y) cos(2 * t) + sin(3 * t);

fprintf('\n4th order rk method\n');

result41a = rk_4(f41, [0 1], 1, 10);
result41b = find_order(0, 1, 1, f41);
disp1(result41a);
disp2(result41b);
plot1(result41a, 'Q2yvst_rk4.png');
plot2(result41a, 'Q2errorvst_rk4.png');
plot3(result41b, 'Q2loglogn_rk4.png');
plot4(result41b, 'Q2orderplot_rk4.png');
...
function result = exact_value(x)
    syms t;
    f1 = 0.5 * sin(2 * t) - (1 / 3) * cos(3 * t) + (4 / 3);
