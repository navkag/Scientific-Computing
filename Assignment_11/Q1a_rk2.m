...
result41a = rk_2(f41, [1 3], 0, 10);
result41b = find_order(1, 3, 0, f41);
disp1(result41a);
disp2(result41b);
plot1(result41a, 'Q1ayvst_rk2.png');
plot2(result41a, 'Q1aerrorvst_rk2.png');
plot3(result41b, 'Q1aloglogn_rk2.png');
plot4(result41b, 'Q1aorderplot_rk2.png');
