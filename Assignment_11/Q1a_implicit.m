...
result41a = implicit_euler(f41, [1 3], 0, 10);
result41b = find_order(1, 3, 0, f41);
disp1(result41a);
disp2(result41b);
plot1(result41a, 'Q1ayvst_implicit.png');
plot2(result41a, 'Q1aerrorvst_implicit.png');
plot3(result41b, 'Q1aloglogn_implicit.png');
plot4(result41b, 'Q1aorderplot_implicit.png');
