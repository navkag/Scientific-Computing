...
fprintf('\npart(a) 2nd order rk method\n');

result41a = rk_2(f41, [0 1], 1, 10);
result41b = find_order(0, 1, 1, f41);
disp1(result41a);
disp2(result41b);
plot1(result41a, 'Q1byvst_rk2.png');
plot2(result41a, 'Q1berrorvst_rk2.png');
plot3(result41b, 'Q1bloglogn_rk2.png');
plot4(result41b, 'Q1borderplot_rk2.png');

function result = rk_2(f, tspan, y0, N)
