...
fprintf('\npart(b) 4th order rk method\n');

result41a = rk_4(f41, [0 1], 1, 10);
result41b = find_order(0, 1, 1, f41);
disp1(result41a);
disp2(result41b);
plot1(result41a, 'Q1byvst_rk4.png');
plot2(result41a, 'Q1berrorvst_rk4.png');
plot3(result41b, 'Q1bloglogn_rk4.png');
plot4(result41b, 'Q1borderplot_rk4.png');
